...
!!! success "Finalizing the Graph"
    Even though the data populated automatically, we still need to connect this process to our physical sample. 
    
    1. Inside your new Sintering entry, use the reference dropdowns to link this process to your **Substance**.
    2. Go back to your overarching **Experiment ELN** and link this step to your project graph.