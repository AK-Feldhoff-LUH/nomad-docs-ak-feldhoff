...
2. **Open the DATA tab**:
   * After creating the entry, switch from **OVERVIEW** to **DATA**.
...
In practice (outside this tutorial), you should publish instrument inventory entries so they are immutable and citable.
